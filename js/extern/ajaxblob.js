// Add ajax transport for array buffers
// Code taken from http://www.artandlogic.com/blog/2013/11/jquery-ajax-blobs-and-array-buffers/
...
$.ajaxTransport("+*", function(options, originalOptions, jqXHR)
{
	...
	// arraybuffers - we need XMLHttpRequest level 2 (so feature-detect against
	// window.FormData), feature detect against window.Blob or
	// window.ArrayBuffer, and then check to see if the dataType is
	// blob/arraybuffer or the data itself is a Blob/ArrayBuffer
	if (window.FormData
